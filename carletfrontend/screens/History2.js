  ...
  useEffect(()=>{
    async function fetchData(){
        ...
        try {
          ...
          if (responseJson['from_you'] != undefined){
            setHistory(responseJson['from_you'])
          }
      ...
      >
        <View style={styles.topbar}>
          <View
            ...
            onTouchStart={() => navigation.navigate('History1')}
            
          >
            <TouchableOpacity>
              <Text style={styles.buttontext}>AS RENTER</Text>
            </TouchableOpacity>
          </View>
          <View
            style={{
          ...
          >
            <TouchableOpacity>
              <Text style={{...styles.buttontext, color: "#ffa000" }}>AS OWNER</Text>
            </TouchableOpacity>
          </View>
...
const renderCard = ({ item, index, separators }) => {
    return ( 
      <Card
        ...
        rating={item.vehicle_renter_rating}
