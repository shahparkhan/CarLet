        ...
        if (responseJson.iban === "This Iban is already registered") {
          ...
          try {
            response = await fetch(
              "http://ec2-65-0-12-151.ap-south-1.compute.amazonaws.com/userregister/",
              {
                method: "post",
                mode: "no-cors",
                headers: {
            ...
            if (
              responseJson["Error"] ===
              "There was some error uploading your registration information. Please try again later"
            ) {
              seterrorMsg(
                "There was some error uploading your registration information. Please try again later"
              );
  ...
  return (
    <View style={styles.container}>
      <KeyboardAwareScrollView>
        ...
        <Text style={styles.subheading}>IBAN</Text>
        <TextField
        ...
        />
        <Text style={styles.key}>Profile Picture</Text>
        <TouchableButton
          title="UPLOAD"
          onPress={PickImage}
